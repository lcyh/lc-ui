import{a4 as y,_ as v,o as b,c as x,G as A,B as a,R as B,z as s,a as l,D as m}from"./chunks/framework.82d16950.js";const{defineComponent:k}=y,V=k({name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:u,openBlock:c,createBlock:r}=y;function p(o,n){const e=u("c-calendar");return c(),r(e,{modelValue:o.curDate,"onUpdate:modelValue":n[0]||(n[0]=i=>o.curDate=i),onChange:o.curDateChange},null,8,["modelValue","onChange"])}const{defineComponent:C,ref:d}=y,F=C({setup(){return{curDate:d(new Date),curDateChange:e=>{console.log(e)}}}});return{render:p,...F}}(),"render-demo-1":function(){const{toDisplayString:u,createTextVNode:c,resolveComponent:r,withCtx:p,createVNode:C,createElementVNode:d,openBlock:F,createBlock:o}=y,n={class:"customize-header"};function e(D,t){const g=r("c-button"),h=r("c-calendar");return F(),o(h,{modelValue:D.curDate,"onUpdate:modelValue":t[0]||(t[0]=_=>D.curDate=_),onChange:D.curDateChange},{header:p(_=>[d("div",n,[c(" 当前日期 "+u(_)+" ",1),C(g,{type:"primary",plain:"",onClick:D.addADay},{default:p(()=>[c("加一天")]),_:1},8,["onClick"])])]),_:1},8,["modelValue","onChange"])}const{defineComponent:i,ref:E}=y,f=i({setup(){const D=h=>{console.log(h)},t=E(new Date);return{curDateChange:D,curDate:t,addADay:()=>{const h=new Date(t.value).getTime()+864e5;t.value=new Date(h)}}}});return{render:e,...f}}(),"render-demo-2":function(){const{toDisplayString:u,createTextVNode:c,resolveComponent:r,withCtx:p,openBlock:C,createBlock:d}=y;function F(e,i){const E=r("c-calendar");return C(),d(E,{onChange:e.curDateChange},{dateCell:p(({isSelected:f,date:D,day:t})=>[c(u(f?"当前选中日期":t),1)]),_:1},8,["onChange"])}const{defineComponent:o}=y,n=o({setup(){return{curDateChange:i=>{console.log(i)}}}});return{render:F,...n}}()}}),J=JSON.parse('{"title":"Calendar 日历","description":"","frontmatter":{},"headers":[],"relativePath":"components/calendar/index.md","filePath":"components/calendar/index.md","lastUpdated":1688721044000}');const w=B('<h1 id="calendar-日历" tabindex="-1">Calendar 日历 <a class="header-anchor" href="#calendar-日历" aria-label="Permalink to &quot;Calendar 日历&quot;">​</a></h1><ul><li>日历组件</li></ul><h2 id="何时使用" tabindex="-1">何时使用 <a class="header-anchor" href="#何时使用" aria-label="Permalink to &quot;何时使用&quot;">​</a></h2><ul><li>显示日期</li></ul><h2 id="基本用法" tabindex="-1">基本用法 <a class="header-anchor" href="#基本用法" aria-label="Permalink to &quot;基本用法&quot;">​</a></h2>',5),N=s("div",null,"Calendar 示例",-1),T=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki material-theme-palenight"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#89DDFF"}},"<"),s("span",{style:{color:"#F07178"}},"template"),s("span",{style:{color:"#89DDFF"}},">")]),l(`
