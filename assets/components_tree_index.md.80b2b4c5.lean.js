...
`),l("span",{class:"line"},[l("span",{style:{color:"#89DDFF"}},"</"),l("span",{style:{color:"#F07178"}},"script"),l("span",{style:{color:"#89DDFF"}},">")])])])],-1);function _(c,t,p,F,r,y){const e=i("render-demo-0"),o=i("demo");return E(),d("div",null,[b,D(o,{customClass:"undefined",sourceCode:`<template>
...
<\/script>
`},{description:n(()=>[m]),highlight:n(()=>[f]),default:n(()=>[D(e)]),_:1})])}const g=C(v,[["render",_]]);export{k as __pageData,g as default};
